...
#         st.caption("X-Axis: Flow Name | Bars: Date (Each flow grouped, dates have same color)")
...
#         # Sort dates to maintain consistent color mapping
#         daily_peak_rps = daily_peak_rps.sort_values('day_str')

#         # OPTION 1: Grouped Bar Chart (like your image)
#         fig_trend_peak = px.bar(
#             daily_peak_rps,
#             x='full_flow_id',
#             y='rps',
#             color='day_str',  # Color by date (all dates same color scheme)
#             title="Max RPS per Flow (Grouped by Date)",
#             labels={'full_flow_id': 'Flow Name', 'rps': 'Max RPS', 'day_str': 'Date'},
#             barmode='group',
#             color_discrete_sequence=['#FF6B6B', '#FFA500', '#FFD93D', '#6BCB77', '#4D96FF']  # Consistent colors for dates
#         )

#         fig_trend_peak.update_layout(
#             xaxis_tickangle=-45,
#             showlegend=True,
#             legend=dict(
#                 orientation="v",
...
#             hovermode='x unified'
#         )
#         st.plotly_chart(fig_trend_peak, use_container_width=True)

#         st.markdown("---")

#         # OPTION 2: Line/Area Chart Alternative
#         st.caption("Alternative View: Line Chart with Area Fill")

#         fig_line_area = px.line(
#             daily_peak_rps,
#             x='full_flow_id',
#             y='rps',
#             color='day_str',
#             title="Max RPS Trend per Flow (Line Chart)",
#             labels={'full_flow_id': 'Flow Name', 'rps': 'Max RPS', 'day_str': 'Date'},
#             markers=True,
#             color_discrete_sequence=['#FF6B6B', '#FFA500', '#FFD93D', '#6BCB77', '#4D96FF']
#         )

#         fig_line_area.update_traces(
#             mode='lines+markers',
#             marker=dict(size=10),
#             line=dict(width=3),
...
#             hovermode='x unified'
#         )
#         st.plotly_chart(fig_line_area, use_container_width=True)       
